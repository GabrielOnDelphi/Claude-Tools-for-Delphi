...
compiles. You do not call them — the `/light-review-Full` skill orchestrates the sequence. Your job is to
...
fixes and compiles. Your final message is your complete output — the `/light-review-Full` skill
