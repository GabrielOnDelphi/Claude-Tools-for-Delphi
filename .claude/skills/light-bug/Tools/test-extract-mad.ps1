# Synthetic-mbox tests for extract-mad.ps1 (the /light-bug pipeline extractor).
# Builds fake mbox files under %TEMP%\extractor-tests\, runs the
...
$TestRoot  = Join-Path $env:TEMP 'extractor-tests'
