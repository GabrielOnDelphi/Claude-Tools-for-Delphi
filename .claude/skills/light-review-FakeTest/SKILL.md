...
Call the **Agent** tool with `subagent_type: "light-review-FakeTest"`.
...
- **Build only via the `light-compiler` agent** (global rule). You launch the resulting exe yourself for pass/fail counts.
